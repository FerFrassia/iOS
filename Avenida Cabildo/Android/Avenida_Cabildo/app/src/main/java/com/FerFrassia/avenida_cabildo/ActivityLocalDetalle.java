...
import com.FerFrassia.avenida_cabildo.fragments.FragmentDetalleDescuentos;
import com.FerFrassia.avenida_cabildo.fragments.FragmentDetalleDetalles;
...
public class ActivityLocalDetalle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.FerFrassia.avenida_cabildo.R.layout.a_locales_detalle);

        Toolbar toolbar = (Toolbar) findViewById(com.FerFrassia.avenida_cabildo.R.id.toolbar);
        ...
        Glide.with(this).load(mLocal.getImagen_fondo())
                .into((ImageView) findViewById(com.FerFrassia.avenida_cabildo.R.id.iv_background));

        ivLogo = (ImageView) findViewById(com.FerFrassia.avenida_cabildo.R.id.iv_logo);
        Glide.with(this).load(mLocal.getImagen_logo())
                .into(ivLogo);

        AppBarLayout appBarLayout = (AppBarLayout) findViewById(com.FerFrassia.avenida_cabildo.R.id.app_bar);
        ...
        ImageView ivFavorito = (ImageView) findViewById(com.FerFrassia.avenida_cabildo.R.id.iv_favorito);
        if(mLocal.isFavorito()){
            ivFavorito.setImageResource(com.FerFrassia.avenida_cabildo.R.drawable.ic_star_amarilla);
        }else{
            ivFavorito.setImageResource(com.FerFrassia.avenida_cabildo.R.drawable.ic_star);
        }

        ((TextView) findViewById(com.FerFrassia.avenida_cabildo.R.id.tv_nombre)).setText(mLocal.getNombre());
        ((TextView) findViewById(com.FerFrassia.avenida_cabildo.R.id.tv_categoria)).setText(mLocal.getCategoria());

        TextView tvDescuento = (TextView) findViewById(com.FerFrassia.avenida_cabildo.R.id.tv_descuento);
        ...
        ViewPager pager = (ViewPager) findViewById(com.FerFrassia.avenida_cabildo.R.id.pager);
    ...
    public void marcarFavorito(View v){
        ...
        if(ActivityMain.user != null){
            ...
            if(mLocal.isFavorito()){
                ...
                iv.setImageResource(com.FerFrassia.avenida_cabildo.R.drawable.ic_star_amarilla);
            }else{
                iv.setImageResource(com.FerFrassia.avenida_cabildo.R.drawable.ic_star);
