...
public class ActivityFavoritos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.FerFrassia.avenida_cabildo.R.layout.a_favoritos);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Favoritos");

        recyclerView = (RecyclerView) findViewById(com.FerFrassia.avenida_cabildo.R.id.rv);
        ...
        if(ActivityMain.favoritos != null && ActivityMain.favoritos.size() > 0){
                ...
                ActivityMain.db.getReference(FirebaseReferences.REF_LOCALES + "/" + ActivityMain.favoritos.get(i)).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(locales.size() == ActivityMain.favoritos.size()){
                            ...
                            adapter = new EfficientRecyclerAdapter<Local>(com.FerFrassia.avenida_cabildo.R.layout.row_local_visibilidad_baja, LocalViewHolder.class, locales){
                                ...
                                public int getLayoutResId(int viewType) {
                                    ...
                                    switch (viewType){
                                        ...
                                        case Local.VISIBILIDAD_ALTA:
                                            return com.FerFrassia.avenida_cabildo.R.layout.row_local_visibilidad_alta;

                                        case Local.VISIBILIDAD_MEDIA:
                                            return com.FerFrassia.avenida_cabildo.R.layout.row_local_visibilidad_media;

                                        case Local.VISIBILIDAD_BAJA:
                                            return com.FerFrassia.avenida_cabildo.R.layout.row_local_visibilidad_baja;
            ...
            findViewById(com.FerFrassia.avenida_cabildo.R.id.tv_sin_items).setVisibility(View.GONE);

        }else{

            findViewById(com.FerFrassia.avenida_cabildo.R.id.tv_sin_items).setVisibility(View.VISIBLE);
