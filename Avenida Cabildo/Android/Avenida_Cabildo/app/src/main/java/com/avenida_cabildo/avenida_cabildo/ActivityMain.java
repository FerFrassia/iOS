...
import com.avenida_cabildo.avenida_cabildo.fragments.FragmentPromociones;
import com.avenida_cabildo.avenida_cabildo.fragments.FragmentTodos;
...
public class ActivityMain extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.avenida_cabildo.avenida_cabildo.R.layout.a_main);

        toolbar = (Toolbar) findViewById(com.avenida_cabildo.avenida_cabildo.R.id.toolbar);
        setSupportActionBar(toolbar);

        DrawerLayout drawer = (DrawerLayout) findViewById(com.avenida_cabildo.avenida_cabildo.R.id.drawer_layout);
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
                this, drawer, toolbar, com.avenida_cabildo.avenida_cabildo.R.string.navigation_drawer_open, com.avenida_cabildo.avenida_cabildo.R.string.navigation_drawer_close);
    ...
    private void inicializarNavigationDrawer(){
        ...
        if(user != null){
            ...
            Glide.with(this).load(user.getPhotoUrl()).into((ImageView)findViewById(com.avenida_cabildo.avenida_cabildo.R.id.iv_foto_usuario));
            ((TextView) findViewById(com.avenida_cabildo.avenida_cabildo.R.id.tv_nombre_usuario)).setText(user.getDisplayName());
            ((TextView) findViewById(com.avenida_cabildo.avenida_cabildo.R.id.tv_mail_usuario)).setText(user.getEmail());

            findViewById(com.avenida_cabildo.avenida_cabildo.R.id.ll_iniciar_sesion).setVisibility(View.GONE);

        }else{

            findViewById(com.avenida_cabildo.avenida_cabildo.R.id.iv_foto_usuario).setVisibility(View.GONE);
            findViewById(com.avenida_cabildo.avenida_cabildo.R.id.tv_nombre_usuario).setVisibility(View.GONE);
            findViewById(com.avenida_cabildo.avenida_cabildo.R.id.tv_mail_usuario).setVisibility(View.GONE);

            findViewById(com.avenida_cabildo.avenida_cabildo.R.id.tv_nav_favoritos).setVisibility(View.GONE);
            findViewById(com.avenida_cabildo.avenida_cabildo.R.id.ll_cerrar_sesion).setVisibility(View.GONE);
    ...
    private void iniciarFragmentos(){
        ...
        pager = (ViewPager) findViewById(com.avenida_cabildo.avenida_cabildo.R.id.vp_principal);
        ...
        TabLayout tabLayout = (TabLayout) findViewById(com.avenida_cabildo.avenida_cabildo.R.id.tab_layout);
