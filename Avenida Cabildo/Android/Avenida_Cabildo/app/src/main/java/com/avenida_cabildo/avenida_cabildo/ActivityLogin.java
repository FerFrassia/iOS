...
public class ActivityLogin extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.avenida_cabildo.avenida_cabildo.R.layout.a_login);

        //Google+ Login
        GoogleSignInOptions gso = new GoogleSignInOptions
                .Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken(getString(com.avenida_cabildo.avenida_cabildo.R.string.default_web_client_id))
                .requestEmail()
                .build();
