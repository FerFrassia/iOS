...
import com.nanosoft.avenida_cabildo.adapters.CategoriasAdapter;
import com.nanosoft.avenida_cabildo.adapters.ViewPagerAdapter;
import com.nanosoft.avenida_cabildo.fragments.FragmentPromociones;
import com.nanosoft.avenida_cabildo.fragments.FragmentTodos;
...
public class ActivityMain extends AppCompatActivity implements View.OnClickListener{
    ...
    private void inicializarNavigationDrawer(){
        ...
        if(user != null){
            ...
            Glide.with(this).load(user.getPhotoUrl()).into((ImageView)findViewById(R.id.iv_foto_usuario));
            ((TextView) findViewById(R.id.tv_nombre_usuario)).setText(user.getDisplayName());
            ((TextView) findViewById(R.id.tv_mail_usuario)).setText(user.getEmail());

            findViewById(R.id.ll_iniciar_sesion).setVisibility(View.GONE);

        }else{

            findViewById(R.id.iv_foto_usuario).setVisibility(View.GONE);
            findViewById(R.id.tv_nombre_usuario).setVisibility(View.GONE);
            findViewById(R.id.tv_mail_usuario).setVisibility(View.GONE);

            findViewById(R.id.tv_nav_favoritos).setVisibility(View.GONE);
            findViewById(R.id.ll_cerrar_sesion).setVisibility(View.GONE);
    ...
    private void iniciarFragmentos(){
        ...
        pager = (ViewPager) findViewById(R.id.vp_principal);
